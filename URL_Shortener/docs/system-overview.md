Designing a URL Shorterner system (like Bit.ly or TinyUrl) involves handling short URL generation, mapping to long URLs, redirection and performance considerations.
